...
public class QuanLyNhanSu {
    ...
    private void themNhanVien() {
        try {
            ...
            if (loai == 1) {
                ...
                double pc = Double.parseDouble(sc.nextLine().replace(",", ""));
                ...
                NhanVien nv = new NhanVienThoiVu(ma, ten, cv, 0, tc); // soGioLam = 0
                dsNhanVien.themNhanVien(nv);
                System.out.println("✅ Da them nhan vien Part-time (gio lam hien tai = 0).");
            }
    ...
    private void taoBangLuong() {
        ...
        try {
            ...
            System.out.println("✅ Da tao bang luong moi cho nhan vien.");
            ghiVaoFile();
        } catch (Exception e) {
    ...
    // ===== XUAT GIO CONG PART-TIME RA FILE =====
    ...
    private void ghiVaoFile() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(FILE_NV))) {
            ...
            System.out.println("❌ Loi ghi file nhanvien: " + e.getMessage());
        }
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(FILE_PB))) {
            ...
            System.out.println("❌ Loi ghi file phongban: " + e.getMessage());
        }
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(FILE_BL))) {
            ...
            System.out.println("❌ Loi ghi file bangluong: " + e.getMessage());
        }
    }
    ...
    private void docTuFile() {
        ...
        if (f.exists()) {
            try (BufferedReader br = new BufferedReader(new FileReader(f))) {
                ...
                System.out.println("❌ Loi doc file nhanvien: " + e.getMessage());
            }
        }
        ...
        if (f2.exists()) {
            try (BufferedReader br = new BufferedReader(new FileReader(f2))) {
                ...
                System.out.println("❌ Loi doc file phongban: " + e.getMessage());
            }
        }
        ...
        if (f3.exists()) {
            try (BufferedReader br = new BufferedReader(new FileReader(f3))) {
                ...
                System.out.println("❌ Loi doc file bangluong: " + e.getMessage());
            }
        }
    }
}
